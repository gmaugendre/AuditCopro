...
st.caption(" ###### Ce projet est encore un prototype mis à disposition gratuitement mais nous vous invitons à nous partager en retour votre expérience en tant qu'utilisateur (pertinence de l'analyse, expression de besoins etc.), par écrit (gael_maugendre@hotmail.com) ou de vive voix (+33 6 14 29 80 29))")
