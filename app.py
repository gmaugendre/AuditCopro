...
st.markdown("---")
st.markdown(" ###### Ce projet pars d'un constat simple: les comptes de copropriété sont souvent abscons pour les non-spécialistes, peuvent présenter des erreurs et manquer de transparence ; un grand livre peut comporter des centaines de pages d'écritures et les conseils syndicaux disposent souvent de peu de moyens ou d'expertise comptable pour assurer leur mission de contrôle des comptes.")
...
st.caption(" ###### Protection des données: aucune donnée de votre copropriété n'est conservée: tous les fichiers sont immédiatement supprimés dés la fin du traitement et aucun rapport n'est conservé.")
