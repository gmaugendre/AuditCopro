...
st.markdown("---")
st.markdown(" ###### Il s'agit d'un prototype mis à disposition gratuitement. Nous vous invitons à nous partager vos commentaires par e-mail (gael_maugendre@hotmail.com), de vive voix (+33 6 14 29 80 29), ou via ce formulaire:")
